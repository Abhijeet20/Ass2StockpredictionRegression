...
#Plotting for training and test
plotdata("Lasso","training",y_pred_train_ridge)
plotdata("Lasso","test",y_pred_ridge)
...
#Plotting for training and test
plotdata("LinearRegression","training",y_pred_train_ridge)
plotdata("LinearRegression","test",y_pred_ridge)
